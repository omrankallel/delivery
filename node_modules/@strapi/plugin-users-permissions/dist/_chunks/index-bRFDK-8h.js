...
const indexDoNaXvrg = require("./index-DoNaXvrg-C5aV1Jb8.js");
...
const index = require("./index-hEmhAD3A.js");
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = indexDoNaXvrg.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(indexDoNaXvrg.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(indexDoNaXvrg.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-bRFDK-8h.js.map
