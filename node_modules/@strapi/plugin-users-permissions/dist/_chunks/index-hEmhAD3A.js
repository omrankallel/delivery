      ...
      [
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-BTHHxmwk.js")),
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-bRFDK-8h.js")),
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-QG0i5P9s.js")).then((mod) => ({
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-CbjVCXNg.js")).then((mod) => ({
...
exports.index = index;
//# sourceMappingURL=index-hEmhAD3A.js.map
